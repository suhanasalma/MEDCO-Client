...
const DoctorSearchFields = () => {
    ...
    const dot = (color = 'transparent') => ({
      ...
      const customeStyles = {
        ...
        singleValue: (styles, { data }) => ({ ...styles, ...dot(data.color || "#2c4c3b"),color:"#2c4c3b", fontWeight:"500", }),
      };
    ...
    return (
        <div className=' w-5/12'>
            <div className=' w-9/12 space-y-5 px-5 py-10 '>
            <div>
                Visit fee
                <div>
                    ...
                    <div className='flex items-center gap-2'>
                        <p>MIN</p>
                        <input className='border-2 w-20 text-center' placeholder={minPriceRange} type='number'/>
                    </div>
                    <span>-</span>
                    <div className='flex items-center gap-2 '>
                        <p>MAX</p>
                        <input className='border-2 w-20 text-center' placeholder={maxPriceRange} type='number'/>
                    </div>
                    </div>
            ...
            <div className='relative border-[1px] border-l-light-gray border-y-light-gray border-r-green py-1'>
                <input className='px-2 outline-none w-11/12' placeholder='Search' type='search'/>
