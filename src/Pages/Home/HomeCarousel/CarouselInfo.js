...
export const CarouselInfo = [
  {
    ...
    id: 1,
    details: `<div class="z-10 absolute top-5 xl:top-32 left-20 space-y-3 lg:space-y-10 2xl:w-4/12 p-4  animate__animated animate__slideInDown"><p class=" text-green font-bold  text-2xl xl:text-4xl">
  ...
  },
  {
    ...
    id: 2,
    details: `<div class="z-10 absolute top-10 xl:top-32 left-20 space-y-3 lg:space-y-10 2xl:w-4/12 p-4  animate__animated animate__slideInLeft"><p class=" text-white font-bold  text-2xl xl:text-4xl">
  ...
  },
  {
    ...
    id: 3,
    details: `<div class="z-10 absolute top-10 md:top-5 xl:top-32 left-20 space-y-3 lg:space-y-10 lg:w-4/12 p-4 animate__animated animate__fadeInRight">
       ...
       <div>
       <button class='lg:w-72 btn hover:text-green bg-green px-6 py-2 rounded-full text-white font-bold  border-2 border-green'>Book Ambulance</button>
       </div>
       </div>
       `,
  },
  {
    ...
    id: 4,
    details: `<div class="z-10 absolute top-20 sm:top-10 xl:top-32 left-20 space-y-3 lg:space-y-10 lg:w-4/12 p-4 animate__animated animate__rotateInUpRight">
        <p class=" text-green font-bold text-2xl xl:text-4xl">
       ...
       <div>
       <button class='lg:w-72 btn hover:text-green bg-green px-6 py-2 rounded-full text-white font-bold border-2 border-green'>Be a Doner</button>
       </div>
       </div>
       `,
  },
  {
    ...
    id: 5,
    details: `<div class="z-10 absolute top-10 xl:top-32 left-20 space-y-3 lg:space-y-10  lg:w-4/12 p-4 animate__animated animate__slideInUp">
  ...
  },
  {
    ...
    imgClass: "animate__animated animate__fadeInLeft",
    id: 6,
    details: `<div class="z-10 absolute top-10 xl:top-32 left-20 space-y-3 lg:space-y-10 lg:w-4/12 p-4 animate__animated animate__fadeInRight">
    <p class=" text-green font-bold  text-2xl xl:text-4xl">
