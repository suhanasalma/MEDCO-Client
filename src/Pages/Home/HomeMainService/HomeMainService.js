...
const HomeMainService = () => {
  ...
  return (
    <div className="my-20 w-10/12 mx-auto  ">
      ...
      />
      <div className="container   mt-10 mb-32 xl:justify-between justify-center xl:flex-nowrap md:flex-wrap md:flex grid sm:grid-cols-2 grid-cols-1 justify-items-center mx-auto">
