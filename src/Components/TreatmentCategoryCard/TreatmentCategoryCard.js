...
const TreatmentCategoryCard = ({data,design,imgDesign,fontDesign}) => {
    return (
      <div
        className={`flex items-center justify-center bg-light-green border-2 border-light-green w-full ml-2 h-24 p-2 text-center rounded-lg hover:bg-white hover:border-2 hover:border-green transition-all ease-in-out duration-500 ${design}`}
      >
        <div>
          <img
