...
const DashboardMenus = () => {
  ...
  const dashboardMenus = [
    ...
    { id: 8, name: "Marketing Kit", icon: TbFileLike },
    {
      id: 9,
      name: "Legal Pages",
      icon: BiDetail,
    ...
    { id: 11, name: "Chats", icon: TbMessageDots },
    { id: 12, name: "Notifications", icon: BiBell },
    { id: 13, name: "Reports", icon: MdOutlineReportProblem },
    { id: 14, name: "Holidays", icon: BiCalendarStar },
    { id: 15, name: "Settings", icon: TbSettings },
  ];
  return (
    <div className="bg-white w-66 min-h-screen p-5">
      ...
      <div className="flex items-center">
        <img className="w-20 h-20 object-cover rounded-full " src="https://img.freepik.com/free-vector/girl-shy-character_1450-155.jpg?w=2000" alt="gir"/>
        <div className="">
